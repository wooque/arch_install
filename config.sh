...
PACKAGES_DE="gdm gnome-control-center networkmanager gnome-terminal nautilus gnome-keyring gnome-tweaks"
PACKAGES_FONTS="noto-fonts-emoji ttf-liberation ttf-ubuntu-font-family ttf-dejavu ttf-droid"
PACKAGES_APPS="gedit gnome-calculator file-roller eog evince rhythmbox transmission-gtk firefox chromium mpv gimp libreoffice-fresh"
