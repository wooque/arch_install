...
if [[ "$DE" = "plasma" ]]; then
PACKAGES_DE="sddm sddm-kcm plasma-desktop kscreen plasma-nm plasma-pa pulseaudio-bluetooth powerdevil bluedevil khotkeys konsole dolphin plasma-workspace-wallpapers kde-gtk-config"
elif [[ "$DE" = "gnome" ]]; then
