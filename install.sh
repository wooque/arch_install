...
PACKAGES_APPS="firefox gedit gnome-calculator gnome-screenshot file-roller eog evince mpv transmission-gtk gimp libreoffice-fresh"
PACKAGES_UTILS="fasd htop ncdu rsync p7zip bluez-utils"
